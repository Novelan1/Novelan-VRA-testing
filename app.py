...
try:
    ...
    st.error("🔐 Login session failed. Please refresh the page or clear your browser cache.")
    st.stop()
...
if auth_status is False:
    ...
    if excel_file and template_file:
        ...
        if 'AppCode' not in df.columns:
            st.error("❌ The column 'AppCode' is missing in the Excel file.")
        else:
            ...
            if st.button("Generate Report"):
                ...
                if group.empty:
                    ...
                    # --- Fill Summary Table (2nd table) ---
                    summary_table = doc.tables[1]
                    system_affected_col = summary_table.cell(1, 0).text
